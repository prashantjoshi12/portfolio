      ...
      <div className="hero-content container">
        <div className="hero-text">
          ...
          <h1 className="hero-name">
            <span className="gradient-text">Prashant Joshi</span>
          </h1>
          <h2 className="hero-title">Backend Developer</h2>
          <p className="hero-description">
            Building scalable APIs and robust backend systems with NestJS, Node.js, and PostgreSQL.
            <br />
        ...
        <div className="hero-image">
          <div className="hero-avatar">
            ...
            <div className="avatar-content">
              <span className="avatar-text">PJ</span>
            </div>
          </div>
        </div>
      </div>
      <div className="hero-scroll">
        <div className="scroll-indicator">
          ...
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path d="M10 15L5 10L6.41 8.59L10 12.17L13.59 8.59L15 10L10 15Z" fill="currentColor"/>
          </svg>
        </div>
      </div>
    </section>
